...
class BoxScorePlayerViewHolder(val binding: ListItemBoxScoreBinding): RecyclerView.ViewHolder(binding.root)

class BoxScoreLeftViewHolder(val binding: ListItemBoxScoreLeftBinding): RecyclerView.ViewHolder(binding.root)
