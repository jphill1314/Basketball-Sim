...
//    val homeTeam = Team("Home", 70)
//    val awayTeam = Team("Away", 80)
...
//        println("${player.lastName}: R:${player.getOverallRating()} M:${player.timePlayed/60} F:${player.fatigue.toInt()} - S:${player.stamina}")
//    }
